...
```{r,fig.keep = 'last', echo = FALSE, results='hide', out.width = "30%"}
set.seed(400)
...
- Use Monte Carlo to compute 200 iterations of the simulation. 
...
- With a recovery rate we see that the spread would eventually stop around day 180.


```{r}
 no_recover = run_co(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 200, GRID = 0.8, use = FALSE, p = TRUE)
 set.seed(400)
 recover = run_co(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 200, GRID = 0.8, use = TRUE, p = TRUE)
