...
```{r, fig.align = "center",out.width = "10%"}
...
- We assumed each person would recover after 13 days
...
plot_both <- function(tempdf){
  ...
  a = ggplot(tempdf)+
    ...
    geom_point(aes(x=1:length(recover),y = recover), color = "blue")+
    geom_line(aes(x = 1:length(recover), y = no_recover,color = "With Recovery"))+
    geom_point(aes(x = 1:length(recover), y = no_recover), color = "red")+
...
```{r,fig.keep = 'last', fig.align = "left",out.width = "10%"}
set.seed(400)
no_recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 25, GRID = 25, use = FALSE, p = TRUE)
set.seed(400)
recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 25, GRID = 25, use = TRUE, p = TRUE)
...
```{r, fig.keep = "last", fig.align = "center",out.width = "10%"}
set.seed(400)
no_recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 50, GRID = 25, use = FALSE, p = TRUE)
set.seed(400)
recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 50, GRID = 25, use = TRUE, p = TRUE)
tempdf = as.data.frame(no_recover)
tempdf$recover = recover
plot_both(tempdf)
...
```{r, fig.align = "right", out.width = "10%"} 

set.seed(400)
no_recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 100, GRID = 25, use = FALSE, p = TRUE)
set.seed(400)
recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 100, GRID = 25, use = TRUE, p = TRUE)
tempdf = as.data.frame(no_recover)
tempdf$recover = recover
