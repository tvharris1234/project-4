...
```{r}
#run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 100, GRID, use = FALSE, p = FALSE)
...
```{r,fig.keep = 'last'}
 ...
 set.seed(400)
 no_recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 100, GRID, use = FALSE, p = TRUE)
 set.seed(400)
 recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 100, GRID, use = TRUE, p = TRUE)
 tempdf = as.data.frame(no_recover)
 tempdf$recover = recover
 plot_both(tempdf)
...
```{r,fig.keep = 'last'} 
 ...
 set.seed(400)
 no_recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 500, GRID, use = FALSE, p = TRUE)
 set.seed(400)
 recover = run(STARTING_POPULATION = 1000, SIMULATION_ITERATIONS = 500, GRID, use = TRUE, p = TRUE)
 tempdf = as.data.frame(no_recover)
 tempdf$recover = recover
 plot_both(tempdf)
...
```
>>>>>>> 11b16fdf70d9c0ca272c205e6cedee3c4941105d
